...
class HomeActivity : AppCompatActivity() {
    ...
    fun getListSound() {
        soundList = listOf(
            Sound(Constant.Sound.CAT, R.drawable.cat_meowing_ic, R.drawable.bg_sound_passive,R.raw.cat_meowing),
            Sound(Constant.Sound.DOG, R.drawable.dog_barking_ic, R.drawable.bg_sound_passive,R.raw.dog_barking),
            Sound(
            ...
            Sound(Constant.Sound.WHISTLE, R.drawable.whistle_ic, R.drawable.bg_sound_passive,R.raw.whistle),
            Sound(Constant.Sound.HELLO, R.drawable.hello_ic, R.drawable.bg_sound_passive,R.raw.hello),
            Sound(Constant.Sound.CAR_HONK, R.drawable.car_horn_ic, R.drawable.bg_sound_passive,R.raw.car_honk),
            Sound(Constant.Sound.DOOR_BELL, R.drawable.door_bell_ic, R.drawable.bg_sound_passive,R.raw.door_bell),
            Sound(Constant.Sound.PARTY_HORN, R.drawable.party_horn_ic, R.drawable.bg_sound_passive,R.raw.party_horn),
            Sound(
            ...
            Sound(Constant.Sound.CAVARLY, R.drawable.cavalry_ic, R.drawable.bg_sound_passive,R.raw.cavalry),
            Sound(
            ...
            Sound(Constant.Sound.RIFLE, R.drawable.rifle_ic, R.drawable.bg_sound_passive,R.raw.rifle),
        )
    }
